...
ALLOWED_HOSTS = ['*']  # Use your actual domain or Render's service URL in production
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'from@gmail.com'  # your sending email
EMAIL_HOST_PASSWORD = 'xyz'         # your email password (use app password if 2FA is enabled)
